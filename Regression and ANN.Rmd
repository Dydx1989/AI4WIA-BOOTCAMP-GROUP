---
title: "Crop Yield Prediction with R:  Linear Regression and ANN "
author: "AI4WIA BOOTCAMP GROUP: Kazeem A. DAUDA"
...
```{r, warning=FALSE,echo=TRUE,message=FALSE, fig.width=10,fig.height=7}
set.seed(123)
n <- 100
